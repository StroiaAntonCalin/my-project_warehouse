...
A Dava.Flow Context Warehouse for a gym scheduling website. Authenticated users can view and manage a personal schedule through seven editable frontend cards and add new exercises.
...
GYM_SCHEDULER coordinates the product and implementation work for a gym scheduling website. Users first log in, then manage their schedule through seven editable cards and can add exercises as needed.
